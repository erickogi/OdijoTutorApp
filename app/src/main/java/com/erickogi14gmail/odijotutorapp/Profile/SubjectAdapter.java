...
public class SubjectAdapter extends RecyclerView.Adapter<SubjectAdapter.MyViewHolder> {
    ...
    public SubjectAdapter(Context context, int view, ArrayList<Subjects> modelList, clickListener listener) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View itemView, int view, clickListener listener) {
            super(itemView);
