...
public class FragmentMyProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_my_profile_tutor, container, false);
        ...
        populate();
        buttonMail = view.findViewById(R.id.btn_mail);
        buttonPhone = view.findViewById(R.id.btn_phone);
        btnZone = view.findViewById(R.id.btn_zone);
        btnSubjects = view.findViewById(R.id.btn_course);
        btnEdit = view.findViewById(R.id.btn_profile_edit_profile);
